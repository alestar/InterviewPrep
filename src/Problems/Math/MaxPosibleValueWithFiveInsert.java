...
public class MaxPosibleValueWithFiveInsert {
    ...
    {
        int num= 63;
        System.out.println("Maximum Possible Value With Problems.Math= " +  maxPossibleValueWithMath(num));
        System.out.println("Maximum Possible Value With Problems.String = " +  maxPossibleValueWithString(num));
    }
