...
public class WordCountEngine {
    ...
    public static List<String> [] createArrayOfCounts(HashMap<String, Integer> map, int size){
        ...
        System.out.println(" Problems.Array Of List Word Counts: " + Arrays.toString(arrOfListWordCounts));
    ...
    public static void main(String[] args) {
        ...
        //Problems.String document = "Practice makes perfect. you'll only get Perfect by practice. just practice!";
