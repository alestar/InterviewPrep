...
public class BinarySearchTree {
    ...
    void printInorder(BinaryTreeNode node, String dir){
        ...
        System.out.println("    " + dir + " Current Node: " + node.toString() + ", ");
    ...
    public static boolean isBinarySearchTreeRecvWithBounds(BinaryTreeNode node) {
    ...
    public static boolean isBinarySearchTreeStack(BinaryTreeNode root) {
    ...
    public static void main(String[] args) {
        ...
        boolean resultRecvBounds = isBinarySearchTreeRecvWithBounds(bt.root);
        boolean resultStack = bt.isBinarySearchTreeStack(bt.root);
        ...
        System.out.println(" Is it a Binary Search  Tree (Stack) ? : " +  resultStack);
    }
}
;